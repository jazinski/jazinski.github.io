export default function Services() {
  const services = [
    ...
    },
    {
      ...
      title: "Cloud & DevOps",
      description:
        "Scalable infrastructure and automated deployment pipelines for reliable applications.",
      features: [
    ...
    },
    {
      ...
      description:
        "Enhancing application speed, efficiency, and user experience through technical excellence.",
      features: [
        "Code optimization",
    ...
    },
    {
      ...
      description:
        "Comprehensive security assessments and vulnerability remediation for your applications.",
      features: [
        "OWASP compliance",
        "Penetration testing",
    ...
    },
    {
      ...
      description:
        "Expert guidance on architecture, technology stack selection, and best practices.",
      features: [
  ...
  const processSteps = [
    ...
    },
    {
      number: 2,
      title: "Planning",
      description: "Creating detailed technical specifications and timeline",
    },
    {
      number: 3,
      title: "Development",
      description: "Building with regular updates and feedback loops",
    },
    {
      number: 4,
      title: "Testing",
    ...
    },
    {
      number: 5,
      title: "Deployment",
      description: "Smooth launch and post-deployment support",
    },
  ];
    ...
    <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="border-t border-dark-border pt-4 mt-auto">
              <div className="text-sm text-gray-500">
                Typical delivery:{" "}
                <span className="text-jazinski-gold font-semibold">
                  {service.delivery}
                </span>
              </div>
            </div>
      ...
      <div className="mb-20">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold mb-4 gold-glow">My Process</h2>
          <p className="text-xl text-gray-400">
          ...
          {processSteps.map((step, index) => (
            <div key={step.number} className="text-center animate-on-scroll">
              ...
              {index < processSteps.length - 1 && (
                <div
                  className="hidden md:block absolute top-8 left-1/2 w-full h-0.5 bg-gradient-to-r from-jazinski-gold to-transparent"
      ...
      <div className="card-geometric p-12 text-center bg-gradient-to-br from-dark-card to-[#1c2028]">
        ...
        <button className="btn-primary text-lg">Schedule a Consultation</button>
      </div>
    </div>
  );
}
